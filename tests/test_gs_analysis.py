...
class smoothing_test_case(unittest.testCase):
    """ tests for the smoothing functions """
    ...
    def test_moving_average(self):
        ...
        self.assertRaises(ValueError, gs.moving_average, counts, window=4)  # even number
        self.assertRaises(ValueError, gs.moving_average, counts, window=-1) # negative number
    ...
    def test_exponential_moving_average(self):
        ...
        self.assertRaises(ValueError, gs.exponential_moving_average, counts, alpha=0.0)  # too low
        self.assertRaises(ValueError, gs.exponential_moving_average, counts, alpha=1.0)  # too high
        self.assertRaises(ValueError, gs.exponential_moving_average, counts, alpha=-0.1) # negative
        self.assertRaises(ValueError, gs.exponential_moving_average, counts, alpha=1.5)  # above 1
...
class peak_finding_test_case(unittest.testCase):
    """ tests for the peak fining functions """
